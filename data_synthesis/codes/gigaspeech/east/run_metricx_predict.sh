...
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_east/slurm_logs/llm_%A_%a.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_east/slurm_logs/llm_%A_%a.err
...
IN=/data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_east/metricx_shards/input_${SHARD_ID}
OUT=/data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_east/metricx_shards/output_${SHARD_ID}.jsonl
