...
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/EAST/gigaspeech_ja/slurm_logs/stage3_metricx_%A_%a.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/EAST/gigaspeech_ja/slurm_logs/stage3_metricx_%A_%a.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=haolingp@andrew.cmu.edu

set -e
echo "===== EAST ja Stage 3 shard ${SLURM_ARRAY_TASK_ID} START $(date) ====="
...
echo "===== EAST ja Stage 3 shard ${SLURM_ARRAY_TASK_ID} DONE $(date) ====="
