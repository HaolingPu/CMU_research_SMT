#!/usr/bin/env bash
# ============================================================
# EAST  ja  -- Stage 4: Merge MetricX outputs -> filter -> final dataset
# ============================================================
#SBATCH --job-name=east_ja_s4_final
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/EAST/gigaspeech_ja/slurm_logs/stage4_final_%A.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/EAST/gigaspeech_ja/slurm_logs/stage4_final_%A.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=haolingp@andrew.cmu.edu

set -e
echo "===== EAST ja Stage 4 START $(date) ====="
...
echo "===== EAST ja Stage 4 DONE $(date) ====="
