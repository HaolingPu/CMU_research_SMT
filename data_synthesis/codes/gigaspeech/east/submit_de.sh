#!/usr/bin/env bash
# Submit the de pipeline: LLM array (8 workers) -> stage1 (post_process + multi_trajectory).
...
echo "  tail -f /data/user_data/haolingp/data_synthesis/outputs/EAST/gigaspeech_de/slurm_logs/llm_${JID_LLM}_0.out"
