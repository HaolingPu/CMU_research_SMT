#!/usr/bin/env bash
#SBATCH --job-name=giga_llm_cache_qwenasr
#SBATCH --nodes=1
...
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/llm_full_translation_cache/slurm_logs/llm_cache_qwenasr_%A_%a.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/llm_full_translation_cache/slurm_logs/llm_cache_qwenasr_%A_%a.err
