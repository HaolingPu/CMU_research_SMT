#!/usr/bin/env bash
# Final (semantic merge) runner: 100 cases = 4 tasks x 25 rows

#SBATCH --job-name=fut_final_sem100
#SBATCH --nodes=1
...
OUTPUT_ROOT="/data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_future_sampling_final/llm_batch_output_final_semantic_merge_100"
