#!/usr/bin/env bash
#SBATCH --job-name=gem_fd_api100_v3
#SBATCH --nodes=1
...
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_future_sampling_thinking_gemini/slurm_logs/gem_fd_api100_v3_%A_%a.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_future_sampling_thinking_gemini/slurm_logs/gem_fd_api100_v3_%A_%a.err
...
OUTPUT_ROOT="/data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_future_sampling_thinking_gemini/gemini_future_distribution_api_gate_100_v3"
