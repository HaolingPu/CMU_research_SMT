...
CONS_OUTPUT="${CONS_OUTPUT:-/data/user_data/haolingp/data_synthesis/outputs/gigaspeech/consensus_decoding_debug/consensus-4k}"
METRICX_RUN_DIR="${METRICX_RUN_DIR:-/data/user_data/haolingp/data_synthesis/outputs/gigaspeech/consensus_decoding_debug/consensus-4k-metricx}"
FILTERED_OUTPUT_DIR="${FILTERED_OUTPUT_DIR:-/data/user_data/haolingp/data_synthesis/outputs/gigaspeech/consensus_decoding_debug/consensus-4k-qe3}"

TOTAL_ROWS="${TOTAL_ROWS:-4000}"
