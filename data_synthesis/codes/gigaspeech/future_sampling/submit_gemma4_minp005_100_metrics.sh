...
# =============================================================================
# One-click pipeline: 100-case dual-base consensus decoding with --min-p 0.05
...
CONS_OUTPUT="${OUTPUT_BASE}/min0.05-100-case"
METRICX_RUN_DIR_BASE="${OUTPUT_BASE}/min0.05-100-case-metricx"
