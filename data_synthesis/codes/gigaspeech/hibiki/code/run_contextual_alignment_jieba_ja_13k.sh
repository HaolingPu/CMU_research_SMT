#!/usr/bin/env bash
#SBATCH --job-name=hibiki_jieba_ja_13k
#SBATCH --nodes=1
...
#SBATCH -o /data/user_data/haolingp/data_synthesis/codes/gigaspeech/hibiki/output/hibiki_ja_13k/slurm_%A_%a.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/codes/gigaspeech/hibiki/output/hibiki_ja_13k/slurm_%A_%a.err
...
OUTPUT_DIR="$HIBIKI_DIR/output/hibiki_ja_13k"
