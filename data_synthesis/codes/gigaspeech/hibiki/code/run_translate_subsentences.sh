...
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/hibiki_logs/trans_subsent_%A_%a.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/hibiki_logs/trans_subsent_%A_%a.err

set -e
echo "===== START SHARD ${SLURM_ARRAY_TASK_ID} ====="
...
OUTPUT_ROOT="/data/user_data/haolingp/data_synthesis/outputs/gigaspeech/eval_datasets/subsentence_ref_shards"
