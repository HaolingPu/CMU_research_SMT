#!/usr/bin/env bash
# ============================================================
# Refined-EAST  Stage 1 — LLM output post-processing
#
# Input  : ${BASE}/llm_output_raw
# Output : ${BASE}/llm_output_merged_fixed
#          ${BASE}/good_train_xl_refined_mfa.jsonl  (→ Stage 2)
#
# Submit : sbatch stage1_llm.sh
# Then   : sbatch stage2_streaming.sh
# ============================================================
#SBATCH --job-name=reast_s1_llm
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_refined_east/slurm_logs/stage1_llm_%A.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_refined_east/slurm_logs/stage1_llm_%A.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=haolingp@andrew.cmu.edu

set -e
echo "===== Refined-EAST Stage 1 — START $(date) ====="
...
echo "===== Refined-EAST Stage 1 — DONE $(date) ====="
