#!/usr/bin/env bash
# ============================================================
# Refined-EAST  Stage 3 — MetricX prediction (8-GPU array job)
#
...
# Then   : sbatch stage4_final.sh   (after ALL 8 tasks finish)
# ============================================================
#SBATCH --job-name=reast_s3_metricx
#SBATCH --array=0-7
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_refined_east/slurm_logs/stage3_metricx_%A_%a.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_refined_east/slurm_logs/stage3_metricx_%A_%a.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=haolingp@andrew.cmu.edu

set -e
echo "===== Refined-EAST Stage 3 shard ${SLURM_ARRAY_TASK_ID} — START $(date) ====="
...
echo "===== Refined-EAST Stage 3 shard ${SLURM_ARRAY_TASK_ID} — DONE $(date) ====="
