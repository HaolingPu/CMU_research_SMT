#!/usr/bin/env bash
# ============================================================
# Refined-EAST  Stage 4 — Merge → filter → final dataset
#
...
#SBATCH --qos=normal
#SBATCH --time=4:00:00
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_refined_east/slurm_logs/stage4_final_%A.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_refined_east/slurm_logs/stage4_final_%A.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=haolingp@andrew.cmu.edu

set -e
echo "===== Refined-EAST Stage 4 — START $(date) ====="
...
echo "===== Refined-EAST Stage 4 — DONE $(date) ====="
echo "Final dataset: ${BASE}/final_jsonl_refined_EAST"
