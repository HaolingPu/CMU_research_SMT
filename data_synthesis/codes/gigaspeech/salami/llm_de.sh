#!/usr/bin/env bash
# ============================================================
# SALAMI LLM raw generation — German target.
#
...
# German SALAMI prompt.
#
# Output: ${BASE}/llm_output_raw/{utt_id}.json
#         (target_lang="German" written into each record)
# ============================================================
#SBATCH --job-name=giga_llm_salami_de
#SBATCH --nodes=1
...
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/SALAMI/gigaspeech_de/slurm_logs/llm_%A_%a.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/SALAMI/gigaspeech_de/slurm_logs/llm_%A_%a.err
