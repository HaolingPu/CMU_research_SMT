#!/usr/bin/env bash
# ============================================================
# SALAMI de — Stage 1: adapt raw → post_process → streaming dataset
#
...
#SBATCH --qos=normal
#SBATCH --time=8:00:00
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/SALAMI/gigaspeech_de/slurm_logs/stage1_%A.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/SALAMI/gigaspeech_de/slurm_logs/stage1_%A.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=haolingp@andrew.cmu.edu

set -e
echo "===== SALAMI de Stage 1 START $(date) ====="
...
echo "===== SALAMI de Stage 1 DONE $(date) ====="
echo "Next: sbatch stage2_metricx_input_de.sh"
