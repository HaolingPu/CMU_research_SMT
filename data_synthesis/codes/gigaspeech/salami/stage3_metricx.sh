#!/usr/bin/env bash
# ============================================================
# Salami  Stage 3 — MetricX prediction (8-GPU array job)
#
...
# ============================================================
#SBATCH --job-name=salami_s3_metricx
#SBATCH --array=0-7
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_salami/slurm_logs/stage3_metricx_%A_%a.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/gigaspeech/train_xl_salami/slurm_logs/stage3_metricx_%A_%a.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=haolingp@andrew.cmu.edu

set -e
echo "===== Salami Stage 3 shard ${SLURM_ARRAY_TASK_ID} — START $(date) ====="
...
echo "===== Salami Stage 3 shard ${SLURM_ARRAY_TASK_ID} — DONE $(date) ====="
