#!/usr/bin/env bash
# ============================================================
# SALAMI de — Stage 3: MetricX QE prediction (8-shard array)
# ============================================================
#SBATCH --job-name=salami_de_s3
#SBATCH --array=0-7
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/SALAMI/gigaspeech_de/slurm_logs/stage3_metricx_%A_%a.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/SALAMI/gigaspeech_de/slurm_logs/stage3_metricx_%A_%a.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=haolingp@andrew.cmu.edu

set -e
echo "===== SALAMI de Stage 3 shard ${SLURM_ARRAY_TASK_ID} START $(date) ====="
...
echo "===== SALAMI de Stage 3 shard ${SLURM_ARRAY_TASK_ID} DONE $(date) ====="
