#!/usr/bin/env bash
# ============================================================
# SALAMI ja — Stage 4: merge MetricX outputs → filter → final
# ============================================================
#SBATCH --job-name=salami_ja_s4
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --qos=normal
#SBATCH --time=4:00:00
#SBATCH -o /data/user_data/haolingp/data_synthesis/outputs/SALAMI/gigaspeech_ja/slurm_logs/stage4_%A.out
#SBATCH -e /data/user_data/haolingp/data_synthesis/outputs/SALAMI/gigaspeech_ja/slurm_logs/stage4_%A.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=haolingp@andrew.cmu.edu

set -e
echo "===== SALAMI ja Stage 4 START $(date) ====="
...
echo "===== SALAMI ja Stage 4 DONE $(date) ====="
