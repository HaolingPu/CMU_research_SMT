...
def main() -> None:
  ...
  # Avoid PyArrow/aws-c-io cleanup crash on exit (Fatal error in event_loop.c:
  # aws_thread_launch). Skip normal interpreter shutdown so Arrow's teardown
  # is not run; output is already written.
  os._exit(0)
