...
# 2. Run llm_output.py
cd /home/haolingp/CMU_research_SMT/data_synthesis/codes/yodas/
# python /home/haolingp/CMU_research_SMT/data_synthesis/codes/yodas/llm_output.py --num-en 1 --num-parquets 1

echo "[OK] Segmentation completed."

# ⭐ 新增：后处理LLM输出，合并单词chunks if it is only one word in the chunk
# python /home/haolingp/CMU_research_SMT/data_synthesis/codes/yodas/post_process_llm_output.py \
...
# python /home/haolingp/CMU_research_SMT/data_synthesis/codes/yodas/export_mfa_corpus.py \
...
# python /home/haolingp/CMU_research_SMT/data_synthesis/codes/yodas/find_bad_json.py \
...
#   --lang en000 \
#   --output-dir /data/user_data/haolingp/outputs/EAST \
#   --good-name good_EAST_en000_all.jsonl \
#   --bad-name bad_EAST_en000_all.jsonl
...
python /home/haolingp/CMU_research_SMT/data_synthesis/codes/yodas/multi_trajectory.py \
  --llm-root /data/user_data/haolingp/outputs/EAST/llm_output_EAST_merged \
  --mfa-root /data/user_data/haolingp/outputs/textgrids \
  --good-root /data/user_data/haolingp/outputs/EAST/good_EAST_en000_all.jsonl \
  --output-root /data/user_data/haolingp/outputs/EAST/streaming_dataset_EAST \
  --langs en000
...
python /home/haolingp/CMU_research_SMT/data_synthesis/codes/yodas/convert_metricx.py \
...
echo "[OK] outputs/EAST/metricx_input_EAST.jsonl generated"
...
METRICX_OUTPUT=/data/user_data/haolingp/outputs/EAST/metricx_output_EAST.jsonl
METRICX_INPUT=/data/user_data/haolingp/outputs/EAST/metricx_input_EAST.jsonl
...
###########################################
THRESH=5.0
FILTERED_OUTPUT=/data/user_data/haolingp/outputs/EAST/metricx_filtered_t${THRESH}_EAST.jsonl

echo "Filtering MetricX results with threshold = $THRESH ..."

python /home/haolingp/CMU_research_SMT/data_synthesis/codes/yodas/filter_metricx.py \
...
python /home/haolingp/CMU_research_SMT/data_synthesis/codes/yodas/final_output.py \
