...
CKPTS_FILE="${SCRIPT_DIR}/ckpts_la_v2.txt"
...
for ckpt in "${CKPTS[@]}"; do
    for seg in "${SEGS[@]}"; do
        out_dir="${CKPT_ROOT}/${ckpt}/evaluation/acl_6060/en-zh-v2/seg${seg}"
...
echo
echo "All scoring done. Per-seg scores are at <ckpt>/evaluation/acl_6060/en-zh-v2/seg<N>/segmentation_output/scores.tsv"
