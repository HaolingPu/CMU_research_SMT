#!/usr/bin/env bash
# en->ja version of infer_slurm.sh
# Chunk-level simuleval (BLEU + AL) on ACL 6060 dev with the ja reference.
...
##SBATCH --requeue
#SBATCH --exclude=babel-p9-32,babel-p9-28,babel-m5-32,babel-o5-24,babel-q5-16,babel-n5-32,babel-o5-16,babel-o5-32,babel-n5-28,babel-s5-24,babel-p5-28
...
# Usage: sbatch infer_slurm_ja.sh <MODEL_PATH> <PROMPT_TYPE>
...
OUTPUT_PATH=${MODEL_PATH}/evaluation/acl_6060/en-ja/seg${SOURCE_SEGMENT_SIZE}
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
    ...
    uv run simuleval \
        ...
        --target /data/user_data/haolingp/datasets/acl_6060/dev.target.ja \
        --use-vllm 1 \
        --temperature 0.6 \
        --top-p 0.95 \
        --top-k 20 \
