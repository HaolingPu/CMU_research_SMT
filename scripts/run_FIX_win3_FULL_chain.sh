...
DECODE_JID="${1:-$(cat /tmp/fix_win3_full40k_decode_jid.txt)}"
FS=/home/haolingp/CMU_research_SMT/data_synthesis/codes/gigaspeech/future_sampling
SEG=${FS}/scripts/segale

DECODE_ROOT=/data/user_data/haolingp/data_synthesis/outputs/gigaspeech/consensus_decoding_prod/J_40k_qwenasr_sentsplit_FIX_win3_FULL40k
...
VARIANT_TAG=FULL40k-win3-splitfix
