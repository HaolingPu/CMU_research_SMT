...
DEFAULT_AUDIO_CLIPS_ROOT_TEMPLATE = "/data/group_data/li_lab/siqiouya/datasets/gigaspeech/audio_clips_zh_PA-{tag}/"
DEFAULT_OUTPUT_FILENAME_TEMPLATE = "train_s_zh-PA-{tag}.jsonl"
...
def parse_args():
    p = argparse.ArgumentParser(
        description="Convert prefix-alignment JSON outputs into Swift/Megatron training JSONL."
    )
...
"""
sbatch \
  --export=ALL,MANIFEST_ROOT=/data/user_data/haolingp/data_synthesis/outputs/gigaspeech/rule_based_SMT/prefix_alignment/pa_40k/qe3-lr-aligned,VARIANT_TAG=40k \
  /home/haolingp/CMU_research_SMT/scripts/train/run_convert2swift_PA.sbatch
"""
