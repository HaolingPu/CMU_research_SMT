...
# EAST-latency2mult zh baseline -- adapted to haolingp env (was mentor siqiouya's).
...
EXP_NAME=gigaspeech-zh-EAST-latency2mult-s_origin-bsz4
TRAIN_DATASET=/data/group_data/li_lab/siqiouya/datasets/gigaspeech/manifests/train_s_zh-EAST-latency2mult_origin.jsonl
