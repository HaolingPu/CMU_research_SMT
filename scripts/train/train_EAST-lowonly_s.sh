...
# EAST-lowonly zh baseline (12.5k) -- adapted to haolingp env (was mentor siqiouya's).
...
EXP_NAME=gigaspeech-zh-EAST-lowonly-s-bsz4
TRAIN_DATASET=/data/group_data/li_lab/siqiouya/datasets/gigaspeech/manifests/train_s_zh-EAST-lowonly12500.jsonl
