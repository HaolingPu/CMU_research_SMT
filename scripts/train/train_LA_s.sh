...
# Required env vars:
#   VARIANT_TAG    -- e.g. 40k  (matches convert2swift_LA output naming)
...
apptainer exec \
  ...
  bash -c '
export train_dataset=/data/group_data/li_lab/siqiouya/datasets/gigaspeech/manifests/train_s_zh-LA-${VARIANT_TAG}.jsonl
