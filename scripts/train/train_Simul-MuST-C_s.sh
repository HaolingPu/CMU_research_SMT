...
# Simul-MuST-C-fixed_v2 zh baseline -- adapted to haolingp env (was mentor siqiouya's).
...
EXP_NAME=gigaspeech-zh-Simul-MuST-C-fixed-v2-s_origin-bsz4
TRAIN_DATASET=/data/group_data/li_lab/siqiouya/datasets/gigaspeech/manifests/train_s_zh-Simul-MuST-C-fixed_v2_origin.jsonl
